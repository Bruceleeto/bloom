...
enum {
        ...
        FGL_H_IDLE      = 1u << 6    /* a local backward branch whose loop body
                                      * only an interrupt can change, so taking
                                      * it means waiting out the slice rather
                                      * than going round again -- see
                                      * emit_local_edge */
};
